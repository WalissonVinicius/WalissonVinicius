...
### 📚 Sobre mim
Sou apaixonado por tecnologia e por transformar ideias em produtos digitais úteis.  
Minha missão é **construir aplicações escaláveis, acessíveis e com foco na experiência do usuário**.  

- 🚀 **Foco atual**: Full Stack com **Next.js + Supabase**  
- 🎨 **Valor**: UI/UX simples, responsiva e pensada para pessoas reais  
- 🌱 **Aprendizado contínuo**: Cloud, DevOps e boas práticas de arquitetura  
- 🤝 **Colaboração**: Gosto de trabalhar em equipe e compartilhar conhecimento  
